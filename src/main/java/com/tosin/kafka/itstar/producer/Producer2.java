...
public class Producer2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        interceptorList.add("com.tosin.kafka.itstar.producer.TimeInterceptor");
...
//            producer.send(new ProducerRecord<String, String>("demo121602", "test"+i));
            //回调
            producer.send(new ProducerRecord<String, String>("demo121602", "testCallBackInterceptor:" + i), new Callback() {
